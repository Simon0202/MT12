...
\date{Printemps 2016}
  ...
  %  \begin{minipage}{0.4\textwidth}
     % \begin{flushleft} \large
        ...
        %\emph{Etablissement : } UniversitŽ de Technologie de Compigne
      %\end{flushright}
    %\end{minipage}
\maketitle
...
\chapter{Classe de fonctions}
  ...
  \left\{
	...
	\end{enumerate}
%Exercice 3
\chapter{PhŽnomne de Gibbs}

%Exercice 4
\chapter{Application des sŽrie de Fourier}
\section{La corde pincŽ}
...
\begin{quote}
Rien de sert de courir, il faut partir ˆ point.
\end{quote}
