...
\date{Printemps 2016}
  ...
  %  \begin{minipage}{0.4\textwidth}
     % \begin{flushleft} \large
        ...
        %\emph{Etablissement : } UniversitŽ de Technologie de CompiÂgne
      %\end{flushright}
    %\end{minipage}
\maketitle
...
%Exercice 1
\chapter{SŽrie de Fourier}
	\begin{enumerate}
		\item $f$ est $2\pi$ pŽriodique, impaire et vaut $f(x)=1, x \in [0,\pi]$ \\ \\
		\begin{enumerate}
			\item Coefficients de Fourier \\ \\
			Les $a(i)$ Žtant nuls. On obtient ainsi les coefficients suivants pour les $b(i)$ : \\ \\
			\begin{centering}
				\begin{tabular}{l l}
			...
			\item Richesse frŽquentielle du signal
			\begin{figure}[h!]
				\centering
	...
	%2.
		\item $f$ est $2\pi$ pŽriodique, impaire et vaut $f(x)=x, x \in [0,\pi]$ \\ \\
		\begin{enumerate}
			\item Coefficients de Fourier \\ \\
			Les $a(i)$ Žtant nuls. On obtient ainsi les coefficients suivants pour les $b(i)$ : \\ \\
			\begin{tabular}{l l}
		...
		%3.
		\item $f$ est $2\pi$ pŽriodique, paire et vaut $f(x)=x, x \in [0,\pi]$ \\ \\
		\begin{enumerate}
			\item Coefficients de Fourier \\ \\
			Les $b(i)$ Žtant nuls. On obtient ainsi les coefficients suivants pour les $a(i)$ : \\ \\
			\begin{tabular}{l l}
		...
		%4.
		\item $f$ est $2\pi$ pŽriodique, paire et vaut $f(x)=x^{2}, x \in [0,\pi]$ \\ \\
		\begin{enumerate}
			\item Coefficients de Fourier \\ \\
			Les $b(i)$ Žtant nuls. On obtient ainsi les coefficients suivants pour les $a(i)$ : \\ \\
			\begin{tabular}{l l}
		...
		%5.
		\item $f$ est $2\pi$ pŽriodique, impaire et vaut $f(x)=x(\pi + |x|), x \in [-\pi,\pi]$ \\ \\
		\begin{enumerate}
			\item Coefficients de Fourier \\ \\
			Les $a(i)$ Žtant nuls. On obtient ainsi les coefficients suivants pour les $b(i)$ : \\ \\
			\begin{tabular}{l l}
...
% 1
	\begin{enumerate}
	\item \[f(x)=(sin\,x)^{1/3}\]
	La fonction f est dŽfinie sur l'intervalle ($-\pi;\pi$). Elle est compos\'ee d'une fonction sinus, ce qui la rend impaire. Elle n'admet aucune valeur interdite et on a $f(0^+)=f(0^-)=\sqrt{0}=0$. Elle est donc continue.
	\begin{figure}[h!]
		\centering
...
% 2
	\item \[f(x)=(sin\,x)^{4/3}\]
	La fonction f est dŽfinie sur l'intervalle ($-\pi;\pi$). Elle n'admet aucune valeur interdite et on a $f(0^+)=f(0^-)=\sqrt[3]{0}=0$. Elle est donc continue.
	\begin{figure}[h!]
		\centering
...
% 3
  ...
  \left\{
      ...
      \end{aligned}
    \right.\]
	La fonction f est dŽfinie sur l'intervalle ($-\pi;\pi$). Elle n'admet aucune valeur interdite et on a $f(0^+)=1$ et $f(0^-)=-1$. Elle n'est donc pas continue en 0.
	\begin{figure}[h!]
		\centering
...
% 4
  ...
  \left\{
      ...
      \end{aligned}
    \right.\]
	La fonction f est dŽfinie sur l'intervalle ($-\pi;\pi$). Elle n'admet aucune valeur interdite et on a $f(0^+)=f(0^-)=0$. Elle est donc continue.
	\begin{figure}[h!]
		\centering
...
% 5
  ...
  \left\{
      ...
      \end{aligned}
    \right.\]
	La fonction f est dŽfinie sur l'intervalle ($-\pi;\pi$). Elle n'admet aucune valeur interdite et on a $f(0^+)=f(0^-)=\sqrt{0}=0$ et $f(\pi/2)=0$ et $\lim\limits_{\substack{x \rightarrow \pi/2 \\ x>\pi/2}} f(x)$. Elle est continue en 0 mais pas en $\pi/2$, elle est donc continue par morceaux.
	\begin{figure}[h!]
		\centering
  ...
  \left\{
      ...
      \end{aligned}
    \right.\]
	La fonction $f$ est continue par morceaux et dŽrivable par morceaux, donc rŽguliÃ¨re par morceaux.
	\end{enumerate}
%Exercice 3
\chapter{PhŽnomÃ¨ne de Gibbs}
\section{DŽmonstration}
Soit f la fonction 2$\pi$-pŽriodique et impaire telle que $f(x) = 1$ sur $[0; \pi]$.\\
...
%Exercice 4
\chapter{Application des sŽrie de Fourier}
\section{La corde pincŽe}
\section{La corde frappŽe}
